...
<html lang="fr">
  ...
  <body class="w-screen h-screen">
    <main class="flex flex-col justify-center">
      ...
      >
        <h3 class=" ">USER:</h3>
        <!-- <h3 class="p-10 ml-7.5 ">USER:</h3> -->
        <div class="flex flex-row justify-between gap-10">
          <h3>Tchache</h3>
          <h3 class="pr-5">Aplication</h3>
        </div>
      </section>
      <section
      ...
      <section class="sm:flex flex-row justify-between items-center">
        <div class="chat-dialog h-[77vh] flex-3 bg-[#D9D9D9] text-2xl"></div>
        ...
        <div
          class="chat-participant chat-dialog h-[77vh] flex-1 bg-[#565857] text-2xl text-center text-amber-100"
        ></div>
      </section>
